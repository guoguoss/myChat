...
export default class Input extends Component {
    state = {
        ...
        _labelPositionTopFocus: new Animated.Value(LABEL_DEFAULT_TOP_FOCUS),
        _labelFontSizeFocus: new Animated.Value(LABEL_FONT_SIZE_FOCUS)
    };
    ...
    renderLabel(){
        ...
        const styleLabelContainer = {
            ...
            top: hasValue ? this.state._labelPositionTopFocus : this.state._labelPositionTop
        };
        const styleLabel = {
            ...styleInput.label,
            fontSize: hasValue ? this.state._labelFontSizeFocus : this.state._labelFontSize
        };
